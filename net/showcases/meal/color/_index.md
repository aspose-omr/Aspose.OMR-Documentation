...
type: docs
url: /net/showcases/meal/color/
feedback: OMRNET
title: Colorful meal preference survey
description: OMR ready meal preference survey in colorful design
keywords:
- examples
- branding
- survey
...
![Colorful meal preference survey template](hospital-breakfast.png)
...
![Colorful meal preference survey filled](hospital-breakfast-recognized.png)
