...
type: docs
url: /net/showcases/tear/horizontal-bw/
title: Black and white OMR form with a horizontal tear line
description: OMR form with a horizontal tear line in black and white
keywords:
- examples
- branding
- survey
...
![Black and white OMR form with a horizontal tear line template](tearline.png)
...
![Black and white OMR form with a horizontal tear line filled](tearline-recognized.png)

```
Element Name,Value,
SEC1,"0,01,11,22,34,45,5"
SEC2,"2,52,45,31,22,13,0"
test_id,"154789782"
test_id,"154789770"
```
...
[Click here](https://github.com/aspose-omr/Aspose.OMR-Documentation/blob/master/net/showcases/download/tearline-horizontal-bw.zip) to download full template sources and related files. 
