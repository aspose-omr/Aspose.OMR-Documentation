...
If the bubble is marked, the content of the corresponding [**write_in**](/omr/net/txt-markup/write_in/) element is saved as an image. It will work even if the [`required`](/omr/net/txt-markup/write_in/#attributes) attribute of the **write_in** is set to `false`.
