...
**color** | string | black | Color of the title text. Can be picked from one of the [supported](/omr/net/supported-colors/) values.
**background_color** | string | _transparent_ | Background color of the title row. Can be picked from one of the [supported](/omr/net/supported-colors/) values.
...
**border_color** | string | black | Color of the title row borders. Can be picked from one of the [supported](/omr/net/supported-colors/) values.
