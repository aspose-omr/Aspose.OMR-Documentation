...
OMRNET-499 | Fixed a layout issue with **Table** ([text markup](/omr/txt-markup/table/) / [JSON markup](/omr/json-markup/table/)) element when header text does not fit in one line. | Fix
...
OMRNET-614 | Fixed the behavior of **WriteIn** element inside **VerticalChoicebox** element ([text markup](/omr/txt-markup/vertical_choicebox/#combining-with-write_in-elements) / [JSON markup](/omr/json-markup/verticalchoicebox/#combining-with-writein-elements)).
n/a | Fixed rendering issues for **Container** elements ([text markup](/omr/txt-markup/container/) / [JSON markup](/omr/json-markup/container/)) that caused left and right margins to be different. | Fix
n/a | **Container** ([text markup](/omr/txt-markup/container/) / [JSON markup](/omr/json-markup/container/)) elements can now be nested within other container elements. | Enhancement
n/a | **Paragraphs** ([text markup](/omr/txt-markup/paragraph/) / [JSON markup](/omr/json-markup/paragraph/)) can now be placed at the top level of the form hierarchy, without wrapping them in **block** elements. | Enhancement
n/a | Improved rendering of **EmptyLine** ([text markup](/omr/txt-markup/empty_line/) / [JSON markup](/omr/json-markup/emptyline/)) elements - now they handle vertical spacing between elements more accurately. | Enhancement
...
n/a | Improved elements wrapping within **paragraphs** ([text markup](/omr/txt-markup/paragraph/) / [JSON markup](/omr/json-markup/paragraph/)). | Enhancement
...
- **AnswerSheet** ([text markup](/omr/txt-markup/answer_sheet/) / [JSON markup](/omr/json-markup/answersheet/))
- **CustomAnswerSheet** ([text markup](/omr/txt-markup/custom_answer_sheet/) / [JSON markup](/omr/json-markup/customanswersheet/))
- **Grid** ([text markup](/omr/txt-markup/grid/) / [JSON markup](/omr/json-markup/grid/))
- **CompositeGrid** ([text markup](/omr/txt-markup/composite_grid/) / [JSON markup](/omr/json-markup/compositegrid/))
- **CheckBox** ([text markup](/omr/txt-markup/checkbox/) / [JSON markup](/omr/json-markup/checkbox/))
...
Added a new value for [paragraph_type](/omr/json-markup/paragraph/#optional-properties) / [type](/omr/txt-markup/paragraph/#attributes) attribute: `ImageWrap`. This allows text to wrap around the image, acting as an alias for the existing value `multiple`.
...
- If the form gets too tall with a lot of vertical spacing between content blocks, try removing unnecessary **EmptyLine** ([text markup](/omr/txt-markup/empty_line/) / [JSON markup](/omr/net/ json-markup/emptyline/)) elements.
