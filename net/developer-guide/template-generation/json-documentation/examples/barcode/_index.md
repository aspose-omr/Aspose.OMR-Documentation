...
type: docs
weight: 10
url: /net/template-generation/json/examples/barcode/
---
## **Create OMR Templates with Barcodes**
Aspose.OMR for .NET provides the option to generate OMR template (.omr) files containing barcodes. For this, you need to add the following part in the json markup.
